...
def inference(cfg):
    ...
    cfg.exp_dir = '/hpf/projects/jquon/sumin/nnssl_dataset/nnssl_results/Dataset005_AVM_T1+C_TOFMRA/NoHoldOut_scratch_ResEnc_cls_DblWarmup_lr_1e-4_5folds_balanced_bsize8/AVM_T1+C_TOFMRA/checkpoints'
